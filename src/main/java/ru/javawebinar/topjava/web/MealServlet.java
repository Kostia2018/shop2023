...
public class MealServlet extends HttpServlet {
    ...
    private ConfigurableApplicationContext apc;
    ...
    public void init() {
        ...
        apc = new ClassPathXmlApplicationContext("spring/spring-app.xml");

        controller = apc.getBean(MealRestController.class);
    ...
    @Override
    public void destroy() {
        log.info("Close spring context {}", apc);
        apc.close();
        super.destroy();
    }
